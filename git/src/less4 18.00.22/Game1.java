...
//                System.out.print(x + 1 /*+ "|"*/); // ne to
    ...
    public static boolean win(char player) {
        if (map[0][0] == player && map[0][1] == player && map[0][2] == player && map[0][3] == player && map[0][4] == player) return true;
        if (map[1][0] == player && map[1][1] == player && map[1][2] == player && map[1][3] == player && map[1][4] == player) return true;
        if (map[2][0] == player && map[2][1] == player && map[2][2] == player && map[2][3] == player && map[2][4] == player) return true;
        if (map[3][0] == player && map[3][1] == player && map[3][2] == player && map[3][3] == player && map[3][4] == player) return true;
        if (map[4][0] == player && map[4][1] == player && map[4][2] == player && map[4][3] == player && map[4][4] == player) return true;


        if (map[0][0] == player && map[0][1] == player && map[0][2] == player && map[0][3] == player && map[0][4] == player) return true;
        if (map[0][1] == player && map[1][1] == player && map[1][2] == player && map[1][3] == player && map[1][4] == player) return true;
        if (map[0][2] == player && map[2][1] == player && map[2][2] == player && map[2][3] == player && map[2][4] == player) return true;
        if (map[0][3] == player && map[3][1] == player && map[3][2] == player && map[3][3] == player && map[3][4] == player) return true;
        if (map[0][4] == player && map[4][1] == player && map[4][2] == player && map[4][3] == player && map[4][4] == player) return true;


        if (map[0][0] == player && map[1][1] == player && map[2][2] == player && map[3][3] == player && map[4][4] == player) return true;
        if (map[0][4] == player && map[1][3] == player && map[2][2] == player && map[3][1] == player && map[4][0] == player) return true;
